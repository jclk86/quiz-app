    ...
    container.append(`<main id="quiz-page" class="col-12" role="main">
      <div id="quiz-container">
        <ul id="progress-section">
          <div class="flex">
            <li id="progress"> Progress: ${questionNumber} / ${question_list.length}</li>
          </div>
          <div class="flex">
...
function renderFeedbackPage() {
  ...
  container.append(`<main id="feedback-page" class="col-12" role="main">
    <div class="vertical-align-middle">
      ...
      <p class="white-large-font">Correct answer: ${question_list[questionNumber - 1].rightAnswer}</p>
      <p class="white-large-font">Your current score: ${score} / ${question_list.length}</p>
    </div>
...
function renderQuizResultPage() {
  ...
  container.append(`<main id="result-page" class="col-12" role="main">
    <div class="vertical-align-middle">
      <p class="white-large-font">${getQuizResultMessage()} You got ${score}/6 right for ${getPercentageGrade(score)}%!</p>
